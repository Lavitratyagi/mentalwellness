                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(height: 8),
                      Text('Weight: 58 kg', style: TextStyle(color: Colors.grey)),
                      Text('Height: 165 cm', style: TextStyle(color: Colors.grey)),
                    ],
                  ),
                ),
              ],
                ...
                Expanded(
                  child: ElevatedButton(
                    style: ElevatedButton.styleFrom(
                      backgroundColor: _isDailySelected ? Colors.purple : Colors.grey[300],
                    ...
                    child: Text(
                      'Daily Tasks',
                      style: TextStyle(color: _isDailySelected ? Colors.white : Colors.black),
                    ),
                  ),
                ),
                SizedBox(width: 8),
                      ...
                      children: [
                        ...
                        ..._dailyTasks.map((task) {
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              leading: Icon(task['icon'], color: Colors.purple),
